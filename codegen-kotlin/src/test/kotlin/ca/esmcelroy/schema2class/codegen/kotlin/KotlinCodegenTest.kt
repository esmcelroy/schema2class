...
class KotlinCodegenTest {
    ...
    fun `constrained AliasType emits value class when option is enabled`() {
        val type = TypeDefinition.AliasType(
            ...
            documentation = null,
            aliasedType = TypeRef.Primitive(PrimitiveType.STRING),
            constraints = listOf(ca.esmcelroy.schema2class.core.ir.Constraint.MinLength(1)),
        )
        ...
        val type = TypeDefinition.ComplexType(
            ...
            properties = listOf(
                PropertyDefinition(
                    ...
                    defaultValue = null,
                    documentation = null,
                    kind = ca.esmcelroy.schema2class.core.ir.PropertyKind.ATTRIBUTE,
                ),
            ),
            contentProperty = PropertyDefinition(
                schemaName = "value",
                ...
                defaultValue = null,
                documentation = null,
                kind = ca.esmcelroy.schema2class.core.ir.PropertyKind.CONTENT,
            ),
        )
