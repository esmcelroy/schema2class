...
[CLAUDE.md](CLAUDE.md). Read that first; it is the single source of truth for
project norms. Highlights:
...
- A git remote exists. Session completion means committed, beads closed, quality
  gates green, and pushed to `origin/main`.
...
- Product plan and phase checklist: [PRD.md](PRD.md)
- User docs source: [docs/](docs/)
- MkDocs config: [mkdocs.yml](mkdocs.yml)
- Deployed docs: <http://esmcelroy.ca/schema2class/>
